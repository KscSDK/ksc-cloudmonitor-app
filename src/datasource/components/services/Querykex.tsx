    ...
    <div className="common-content">
      <div className="form-field">
        <FormField
          ...
          onChange={(e) =>
            setKecQuery((state) => ({ ...state, MaxResults: e.target.value }))
          }
        />
      </div>
      <div className="form-field">
        <FormField
          ...
          placeholder="Marker"
          onChange={(e) =>
            setKecQuery((state) => ({ ...state, Marker: e.target.value }))
          }
        />
      </div>
      ...
      <SwitchIncrement
        ...
        datasource={[""]}
        onChange={(value) =>
          setKecQuery((state) => ({ ...state, ["InstanceId"]: value }))
        }
      />
      ...
      <SwitchIncrement
        ...
        datasource={[""]}
        onChange={(value) =>
          setKecQuery((state) => ({ ...state, ["ProjectId"]: value }))
        }
      />
      ...
      <SwitchInput
        ...
        onChange={(value: any) =>
          setKecQuery((state) => ({ ...state, Search: value }))
        }
      />
    </div>
  );
