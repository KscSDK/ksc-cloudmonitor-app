    ...
    <div className="common-content">
      <div className="form-field">
        <FormField
          ...
          onChange={(e) =>
            setEipQuery((state) => ({ ...state, MaxResults: e.target.value }))
          }
        />
      </div>
      <div className="form-field">
        <FormField
          ...
          onChange={(e) =>
            setEipQuery((state) => ({ ...state, NextToken: e.target.value }))
          }
        />
      </div>
      <div className="form-field">
        <FormField
          ...
          onChange={(e) =>
            setEipQuery((state) => ({ ...state, IpVersion: e.target.value }))
          }
        />
      </div>
      ...
      <SwitchIncrement
        ...
        datasource={[""]}
        onChange={(value) =>
          setEipQuery((state) => ({ ...state, ["AllocationId"]: value }))
        }
      />
      ...
      <SwitchIncrement
        ...
        datasource={[""]}
        onChange={(value) =>
          setEipQuery((state) => ({ ...state, ["ProjectId"]: value }))
        }
      />
