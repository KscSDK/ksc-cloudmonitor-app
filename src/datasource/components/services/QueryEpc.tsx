    ...
    <div className="common-content">
      <div className="form-field">
        <FormField
          ...
          onChange={(e) => setEpc((state) => ({ ...state, MaxResults: e.target.value }))}
      ...
      <div className="form-field">
        <FormField
          ...
          onChange={(e) => setEpc((state) => ({ ...state, NextToken: e.target.value }))}
      ...
      <SwitchIncrement
        label="ProjectId"
        datasource={['']}
        onChange={(value) => setEpc((state) => ({ ...state, ProjectId: value }))}
      />
